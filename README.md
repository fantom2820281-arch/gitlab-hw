<<<<<<< HEAD
# Домашняя работа по Githab
=======
# Домашняя работа по gitlab-hw
>>>>>>> dev
...
выполняем настройку репозитория 

репозиторий растроили  все команды и ход выполнения на скриншоте ниже 

---

![начало](HW-screen1.png)

---

ссылка на состояние репозитория после выполнения первого задания
...
---
создаем файл .gitignore в него добавляем все что нужно игнорировать 
...
![Граф коммитов](https://github.com/fantom2820281-arch/gitlab-hw/network)
